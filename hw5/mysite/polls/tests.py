...
class QuestionModelTests(TestCase):
    ...
    def test_was_published_recently_with_old_question(self):
        '''
        wsa_published_recently() returns False for questions whose pub_date
        is older than 1 day.
        '''
    ...
    def test_was_published_recently_with_recent_question(self):
        '''
        was_publiched_recently() returns True for questions whose pub_date
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_future_question(self):
        '''
        Questions with a pub_date in the future artn't displayed on
        the index page.
        '''
