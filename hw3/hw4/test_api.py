...
class TestSuite(unittest.TestCase):
    ...
    def setUp(self):
        self.context = {}
        self.headers = {}
        self.settings = api.Storage(host=api.config['STORE_URL'], port=api.config['STORE_PORT'],
                                    db=api.config['NUMBER_DB'], reconnect=api.config['NUM_RECONNECT'])
    ...
    def test_ok_score_request(self, arguments):
        ...
        #key = "uid:" + hashlib.md5("".join(arguments.values())).hexdigest()
